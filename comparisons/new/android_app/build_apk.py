...
class DriveByAPKBuilder:
    def __init__(self):
        ...
        self.project_root = self.android_dir.parent
    ...
    def setup_build_environment(self) -> None:
        ...
        files_to_copy: List[str] = [
            ...
            # Requirements
            "requirements.txt",
            # "requirements_2024.txt",  # Not present in repo listing; copy if exists below
        ...
        for fname in android_files:
            src = self.android_dir / fname
            if src.exists():
                dst = self.build_dir / fname
                shutil.copy2(src, dst)
    ...
    def build_apk(self, debug: bool = True) -> bool:
        ...
        try:
            # Initialize buildozer if needed (safe even if spec already exists)
            ...
            # Run build process and stream output
            ...
            if process.returncode == 0:
                ...
                if bin_dir.exists():
                    apk_files = sorted(bin_dir.glob("*.apk"))
                    if apk_files:
            ...
            print(" 'buildozer' not found. Ensure Buildozer is installed and on PATH.")
            return False
        except Exception as e:
    ...
    def create_signing_config(self) -> bool:
        ...
        if not keystore_path.exists():
            ...
            keytool_cmd = [
                ...
                "driveby123",
                "-dname",
                "CN=DriveBy,OU=Security,O=DriveBy,L=Unknown,S=Unknown,C=US",
            ]
    ...
    def build_full_apk(self, clean: bool = False, debug: bool = True) -> bool:
